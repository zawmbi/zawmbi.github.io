    ...
    return (
        <div>
            <main className="about-text">
                ...
                <p className="about-paragraph">
                I am a post-bacc researcher at UIC working in bioinformatics for plant transcriptomics and phylogenomics. I build production-style Python and R pipelines, including MissMap, to query NCBI/GenBank, resolve taxon synonyms, and map sequence-type coverage (rbcL, matK, ITS; plastid, mitochondrial, nuclear; transcriptomes). I also serve as a Biology TA. I am seeking bioinformatics roles and a PhD lab in computational phylogeny, genetics, or evolution, with an emphasis on reproducible data pipelines and comparative genomics.
                </p>
                <p className="about-paragraph">
